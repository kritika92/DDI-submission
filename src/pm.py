...
def main():
    ...
    parent_parser.add_argument('-t', '--type', dest='type', help='The type of the project created from a specific template')
    parent_parser.add_argument('-p', '--path', dest='path', help='The base path in which to create the project. If not supplied, it uses a default project path')
